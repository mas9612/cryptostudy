...
func main() {
	...
	answer := []byte{0x35, 0x25, 0x84, 0x1d, 0x02, 0xdc, 0x09, 0xfb, 0xdc, 0x11, 0x85, 0x97, 0x19, 0x6a, 0x0b, 0x32}
	...
	cipherText := aes.Cipher(plainText, key, aes.ModeECB, []byte{})
	...
	decrypted := aes.InvCipher(cipherText, key, aes.ModeECB, []byte{})
	...
	answer = []byte{0xdd, 0xa9, 0x7c, 0xa4, 0x86, 0x4c, 0xdf, 0xe0, 0x6e, 0xaf, 0x70, 0xa0, 0xec, 0x0d, 0x71, 0x91}
	fmt.Println("Before Cipher:")
	for _, b := range plainText {
		fmt.Printf("%02x ", b)
	}
